        ...
        <div class="row-fluid">
          ...
          <div class="span12" style="margin-left:0px;">
            ...
            <div class="tabbable">
				...
				<label for="form-field-select-1">Vehicle</label>
...
WHERE installation_status='completed' AND customer_id=$id and category_id!=4";
                    ...
                    <label for="form-field-select-1">Tag Name</label>
            ...
            <div class="row-fluid">
								...
								<h3 class="header smaller lighter blue">ITC Tags</h3>
...
INNER JOIN installation ON itctags.device_id = installation.model_id

WHERE itctags.customer_id=$id");
...

{
	...
	$("#device").html('Please complete the tag');
...

{
	...
	$("#device").html('Please select your vehicle');
...

{
	...
	$("#device").html('Please name your tag');
...

{
	...
	$("#device").html('Tag Not Added Successfully.');
	...
	$("#device").html('Tag has been created successfully.');
...
xmlhttp.open("GET","ajax/saveitctag.php?c="+path+"&f="+fence+"&dev="+dev+"&cu=<?php echo $id; ?>",true);
...
xmlhttp.send();
		  ...
		  $('#showData').click(function(){ 
		 		...
		 		if(null==creator.showData()){
		 			...
		 			$('#device').html('Please first create a tag');
		 ...
		 $('#showColor').click(function(){ 
		 		...
		 		if(null==creator.showData()){
		 			...
		 			$('#dataPanel').append('Please first create a tag');
...
$("#fence_data").delegate( "[id^=viewF]", "click", function() {
		// $("[id^=viewF]").click(function(e) {
			 ...
			 var polyFence = new google.maps.Polygon({
				   ...
				   url: "ajax/get_polygon_itc.php?fence="+id,
		...
		//$("[id^=deleteF]").click(function(e) {
            ...
            $.ajax({
				   ...
				   url: "ajax/rmv_fence_itc.php?fence="+id,
...
*/			// $("[id^=fStatus]").editable({          
					$("#fence_data").editable({       
					   selector: '[id^="fStatus"]',
   					   url: 'ajax/edit_fence_status_itc.php',
