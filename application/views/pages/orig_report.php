											...
											<div class="widget-body">
                                                ...
                                                <div class="span6">
													...
													<div class="control-group">
														...
														<input id="timepicker2" type="text" name="totime" value="10:00:25" class="input-small" />
...
WHERE installation_status='completed' AND customer_id=$id ";
                        ...
                        <?php }?>		
													...
													<div class="form-actions center">
														...
														<button  class="btn btn-small btn-success" onClick="v_d_d_r_submit();return false">
                                                        ...
                                                        <i class="icon-spinner icon-spin orange bigger-125" id="load_spin"></i>                                                       
                    ...
                    <div id="result" style="background-color:#eff3f8"></div>
...
<![endif]-->
   ...
   <script type="text/javascript">
			...
			function v_d_d_r_submit(){
                ...
                var formURL = "ajaxfiles/<?php   echo $report['report_link']; ?>.php";
