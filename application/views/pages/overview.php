...
$points=array();	
$sqld1="SELECT lat,lng,speed FROM `gps_master` WHERE imei='".$rw['imie_no']."' AND $time_field BETWEEN '$start' AND '$end' AND  lat between 7 and 35 and lng between 65 and 95 and device_status='A' and speed > 3 group by lat,lng ORDER BY $time_field";
...
$dur=convertToHoursMins($rwna['total'], '%d hrs %d m');	
