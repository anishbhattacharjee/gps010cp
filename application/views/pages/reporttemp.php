...
WHERE installation_status='completed' AND customer_id=$id and installation.imie_no!='0358899053752559'";
                        ...
                        <?php } ?>
                                                    ...
                                                    <div class="row-fluid">
														...
														<label for="duration">Interval</label>
...
<![endif]-->
   ...
   <script type="text/javascript">
			...
			function v_d_d_r_submit(){	
                ...
                var formURL = "ajax/report_v_temperature.php";
