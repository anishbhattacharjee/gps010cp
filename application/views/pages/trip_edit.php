												...
												<div class="row-fluid">
													<div id="fuelux-wizard" class="row-fluid hide" data-target="#step-container">
														<ul class="wizard-steps">
															<li data-target="#step1" class="active">
																...
																<span class="title">Basic Configuration</span>
															</li>
													...
													<div class="step-content row-fluid position-relative" id="step-container">
														<div class="step-pane active" id="step1">
															<h3 class="lighter block green">Basic information</h3>
...
FROM
installation
WHERE installation_status='completed' AND customer_id=$id and category_id in (1,2)";// and category_id in (1,2)";
															$rs=mysql_query($sql);
															while($dev=mysql_fetch_assoc($rs)){														

															?>

                        <option value="<?php echo $dev['imie_no']; ?>" <?php if($dev['imie_no']==$rw['imei']){?> selected="selected" <?php } ?>/><?php echo $dev['device_name']; ?>	</option>
                        ...
                        <?php } ?>		
                                                                ...
                                                                <!------------------------------->
																 ...
																 <div class="control-group">
																	...
																	<div class="controls">
																		<input type="text" id="form-field-trip" placeholder="Trip Name" value="<?php echo $rw['trip_name']; ?>" name="trip">
																...
																<div class="control-group">
																	...
																	<div class="controls">
                                                                    	...
                                                                    	<div class="row-fluid input-prepend">
																			...
																			<input type="text" id="id-date-picker-1" class="date-picker" placeholder="Start Time" name="start" data-date-format="dd-mm-yyyy" value="<?php echo date("d-m-Y",strtotime($rw['start_time'])); ?>">
                                                                         ...
                                                                         <div class="input-prepend bootstrap-timepicker">
                                                                            ...
                                                                            <input id="timepicker1" type="text" class="timepicker input-small"  name="startt" value="<?php echo date("H:i:s",strtotime($rw['start_time'])); ?>"/>
                                                                ...
                                                                <div class="control-group">
																	...
																	<div class="controls">
                                                                    	...
                                                                    	<div class="row-fluid input-prepend">
																			...
																			<input type="text" id="id-date-picker-2" class="date-picker" placeholder="End Time" name="end" data-date-format="dd-mm-yyyy" value="<?php echo date("d-m-Y",strtotime($rw['end_time'])); ?>">
                                                                         ...
                                                                         <div class="input-prepend bootstrap-timepicker">
                                                                            ...
                                                                            <input id="timepicker2" type="text" class="timepicker input-small" name="endt" value="<?php echo date("H:i:s",strtotime($rw['end_time'])); ?>" />
                                  ...
                                  <div class="row-fluid">                                
                                    ...
                                    <input type="hidden"  id="dataPanel" name="dp" value="<?php echo $rw['start_tag']; ?>" /> 								  </div>
								</div>
                                </div>
                                 <!-------------------->
                                 <div class="hr hr-dotted"></div>
                                 ...
                                 <!-------------------->
									...
									<div class="controls">										
                                         	<div id="panel">
                                              ...
                                              <input type="button" class="btn btn-small" value="Search" onclick="codeAddress(map3,'')">
			...
			/*****************/
				...
				$('#fuelux-wizard').ace_wizard().on('change' , function(e, info){
					...
					if(info.step == 1 && $validation) {
						...
						if(tags_addd==''){
							...
							var r = confirm("You have not created any trip tags!! Press 'OK' to continue without tags or 'Cansel' to stay back.");
							if (r == true) {
					...
					var formURL = "ajax/edit_trip.php";	
					$.ajax(
						{
							url : formURL,
							type: "POST",
				...
				$("#save_tag").click(function(e) {
                    ...
                    if(path=='Please first create a polygon' || creator3.showData()==null){
						...
						$.ajax({
						type: "GET",
						url: "ajax/save_trip_tag.php?path="+path+"&tag_name="+tag_name+"&loc="+loc+"&date="+tag_time+"&time="+tag_time_t,
						dataType: 'html',
