<?php
$data = $this->trip_model->getTripView($id,$page,$id1);
if(isset($data[0]) && $data[0]){
	$rw = $data['rw'][0];
	$rs = $data['rs'];

	$stat_label=$this->commonfunctions_model->getStatClass($rw['trip_status']);
}else{
	$stat_label = '';
}
?>
										...
										<div class="widget-body">
                                          ...
                                          <div class="profile-user-info profile-user-info-striped">
											<div class="profile-info-row">
												<div class="profile-info-name">  Your Trip Name </div>
